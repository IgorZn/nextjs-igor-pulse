...
import { FaBath, FaBed, FaMoneyBill, FaRulerCombined, FaMapMarker, FaTrash } from 'react-icons/fa'
...
function PropertiesCard(props) {
	...
	const { handleBookmark, message } = useHandleBookmark(props._id)
			...
			<>
				<div className="relative rounded-xl shadow-md">
					...
					{pathname.includes('saved') && (
						<button
							onClick={() => {
								handleBookmark().then(() => setShow(!show))
							}}
							className="absolute left-0 top-0 ml-2 mt-2 flex size-8 items-center justify-center rounded-full bg-white p-2 transition-colors hover:bg-red-100">
					...
					<div className="p-4">
						...
						<div className="mb-4 flex justify-center gap-4 text-gray-500">
							...
							<p>
								<FaRulerCombined className={'mr-2 inline'} /> {props.square_feet}
						...
						<div className="mb-4 flex flex-col justify-between lg:flex-row">
							<div className="mb-4 flex gap-2 align-middle lg:mb-0">
								<FaMapMarker className={'mt-1 inline text-orange-500'} />
