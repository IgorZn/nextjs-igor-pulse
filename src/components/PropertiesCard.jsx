...
import {FaBath, FaBed, FaMoneyBill, FaRulerCombined, FaMapMarker} from "react-icons/fa";
            ...
            <div className="rounded-xl shadow-md relative">
                ...
                <div className="p-4">
                    ...
                    <div className="flex justify-center gap-4 text-gray-500 mb-4">
                        ...
                        <p>
                            <FaRulerCombined className={'inline mr-2'}/> {props.square_feet}
                            <span className="md:hidden lg:inline">sqft</span>
                        </p>
                    </div>

                    <div className="flex justify-center gap-4 text-green-900 text-sm mb-4">
                        {props.rates.nightly && <p><FaMoneyBill className={'inline mr-2'}/> Nightly</p>}
                        {props.rates.weekly && <p><FaMoneyBill className={'inline mr-2'}/> Weekly</p>}
                        {props.rates.monthly && <p><FaMoneyBill className={'inline mr-2'}/> Monthly</p>}
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between mb-4">
                        <div className="flex align-middle gap-2 mb-4 lg:mb-0">
                            <FaMapMarker className={'inline mt-1 text-orange-500'}/>
                            <span className="text-orange-700"> {props.location.city} {props.location.state}</span>
                        </div>
                        <Link
