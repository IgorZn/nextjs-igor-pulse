...
import { FaExclamationTriangle, FaArrowLeft, FaBed, FaBath, FaRulerCombined, FaCheck } from 'react-icons/fa'
				...
				<div className="container m-auto max-w-2xl py-24">
					<div className="m-4 rounded-md border bg-white px-6 py-24 shadow-md md:m-0">
						...
						<div className="text-center">
							<h1 className="mb-2 mt-4 text-3xl font-bold">Property Not Found</h1>
									...
									<div className="mt-6 rounded-lg bg-white p-6 shadow-md">
										...
										<ul className="grid list-none grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
											{property.amenities.map((amenity, index) => (
												<li key={index}>
													<FaCheck className="mr-1 inline text-green-600"></FaCheck> {amenity}
												</li>
											))}
										</ul>
									</div>
